  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='身份' prop="yonghuShenfen">
               <el-input v-model="ruleForm.yonghuShenfen"  placeholder='身份' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuShenfen)&& 'yonghu'==this.flag){
