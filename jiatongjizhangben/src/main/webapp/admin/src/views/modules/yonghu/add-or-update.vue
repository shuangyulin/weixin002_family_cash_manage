    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身份" prop="yonghuShenfen">
                       <el-input v-model="ruleForm.yonghuShenfen"
                                 placeholder="身份" clearable  :readonly="ro.yonghuShenfen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="身份" prop="yonghuShenfen">
                           <el-input v-model="ruleForm.yonghuShenfen"
