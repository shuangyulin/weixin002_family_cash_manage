<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#07588D","height":"200rpx"}'>
            ...
            <view v-if="tableName=='yonghu'" class="userinfo">
                ...
                <view class="info">
                    <view class="username"
                        ...
                        {{user.yonghuName}}</view>
                </view>
            </view>

            <view class="setting" :style='{"color":"#4477C5","fontSize":"40rpx"}'>
        ...
        <view class="list">
            ...
            <view v-for="item in menuList" v-bind:key="item.roleName">
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#07588D","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                                @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li"
                                hover-class="hover">
                            <view :style='{"color":"#4477C5","fontSize":"28rpx"}' class="text">
                                {{child.menu}}</view>
                            <view class="cuIcon-right" :style='{"color":"#4477C5","fontSize":"28rpx"}'>
                            </view>
                        </view>
                    </view>
                </view>
			...
			<view @tap="onPageTap('../forum/forum-my')"
                  :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#07588D","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                  class="li" hover-class="hover">
                <view class="text" :style='{"color":"#4477C5","fontSize":"28rpx"}'>我的发贴</view>
                <!-- <image class="to" :style='{"color":"#4477C5","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                <view class="cuIcon-right" :style='{"color":"#4477C5","fontSize":"28rpx"}'></view>
            </view>
