    ...
    <view
        ...
        <view class="image-view">
            <image :style='{"borderRadius":"0px","width":"100%","height":"100%"}' mode="aspectFill"
                   class="uni-product-image" :src="product.newsPhoto?product.newsPhoto.split(',')[0]:''"></image>
        </view>
        <view class="uni-product-price" v-if="product.newsNewMoney != null"
              :style='{"fontSize":"24rpx","lineHeight":"60rpx","color":"#999","textAlign":"left"}'>
            <text class="">￥{{product.newsNewMoney}}</text>
        </view>
        <view style="display: flex;justify-content: space-between;">
            <text v-if="isAuth('news','修改')" class="cuIcon-edit"
            ...
            :style='{"boxShadow":"0 0 0px rgba(0,0,0,0) inset","backgroundColor":"#07588D","borderColor":"rgba(57, 78, 99, 1)","borderRadius":"40rpx","color":"rgba(0, 0, 0, 1)","borderWidth":"0","width":"40%","fontSize":"28rpx","borderStyle":"solid","height":"76rpx"}'
